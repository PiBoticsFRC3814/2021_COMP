...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    final JoystickButton ClimberUp = new JoystickButton(operatorStick, 1);
    final JoystickButton ClimberDown = new JoystickButton(operatorStick, 2);
    final JoystickButton BalancerLeft = new JoystickButton(operatorStick, 3);
    final JoystickButton BalancerRight = new JoystickButton(operatorStick, 4);
